          ...
          public function __construct($id, MainBG $plugin) { 
                    ...
                    $p->sendMessage($this->plugin->getMsg('has_not_permission')); 
                     ...
                     $p->sendMessage($this->plugin->getPrefix().$msg); 
                               ...
                               public function joinToArena(Player $p) { 
                                if($p->hasPermission("bg.access") || $p->isOp()){ 
                                if($this->setup === true){ 
           ...
           $p->getArmorInventory()->setChestplate(Item::get(0, 0, 1)); 
            ...
            $winnerName = $p->getName(); 
             $player->sendMessage(TextFormat::BOLD . TextFormat::AQUA . $winnerName . TextFormat::GREEN . " has won the game in " . TextFormat::YELLOW . "Battlegrounds!"); 
               } 
            } 
             $this->stopGame();
           } 
                      ...
                      foreach($this->ingamep as $p){ 
                       ...
                       $this->openTeleporter($p);
                         ...
                         $f = 8; 
                         $snowball = Entity::createEntity("Snowball", $p->getLevel(), $nbt, $p); $snowball->setMotion($snowball->getMotion()->multiply($f)); 
               ...
               $explosion->explodeB(); 
                ...
                break; 
                 ...
                 $z = $p->z + 3; 
                  ...
                  if($item->getId() == 53 && $item->getCustomName() == TextFormat:: AQUA . "[ Build A Stairs]"){
                  $e->setCancelled();
