                              ...
                              $fname = basename($file, ".yml"); $this->getLogger()->error("Arena \"$fname\" is not set properly"); 
                                ...
                                public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool {
                                                      ...
                                                      case "set": 
                                                       ...
                                                       $sender->sendMessage($this->getPrefix().$this->getMsg('enable_setup_mode')); 
                                                        ...
                                                        if(!$sender->hasPermission("bg.command.help")){ 
                                                         ...
                                                         $msg = "Â§9--- Â§cÂ§lBattlegrounds HelpÂ§lÂ§9 ---Â§rÂ§f"; 
                                   ...
                                   if($sender->getPlayer()->getLevel()->getFolderName() != "MainSpawn"){ 
                                        $sender->sendMessage("Please do this thing on lobby!"); 
                                        break; 
                                      } 
        ...
        if (is_file($file)) unlink($file); 
            ...
            $this->setters[strtolower($p->getName())]['type'] = 'setlobbypos';
             ...
             case 'spectatorspawn': 
              ...
              $help2 = $this->getMsg('help_time') . $this->getMsg('help_allowstatus') . $this->getMsg('help_world') . $this->getMsg('help_statusline'); 
            ...
            $help = "§9--- §6§lSetup Help§l $args[1]/3§9 ---§r§f"; 
